    ...
    return const Row(
      children: [
        Tooltip(
          message: "오둥이입니다.",
          child:Image(
            image: AssetImage("assets/5doong3.png"),
            width: 100,
            height: 200,
          )
        ),
        // Image(
        //   image: NetworkImage("https://i.namu.wiki/i/SuA3SfoZpx4aMtwJnT3rXPHtGU_QWvyILJG7EGNCYfAGQD_aXw5T3LY5_Nxj_j5Dwfacw1J7gj0ZEyACq5U3UE9hw74WEckCkNpbYJdD2IeQwvvFxJ8MeaIU9UcHgMpndZ_XfgRoO4RGg3rdd7aIlA.webp"),
        //   width: 100,
        //   height: 100,
        // ),
      ],
